...
public class AttachImageBottomSheetModal extends BottomSheetDialogFragment {
    ...
    private File createImageFile() throws IOException {
        ...
        File image = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" + requireContext().getPackageName() + "/",  imageFileName + ".jpg");
        // create directory
        File dir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" + getContext().getPackageName() + "/");
        if (!dir.exists()) {
            dir.mkdirs();
        }
